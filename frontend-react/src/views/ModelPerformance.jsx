...
export default function ModelPerformance() {
  ...
  if (!card) return <EmptyState>No model report artefacts in this profile. Configure the model report directory or keep model_outputs/last_training on the deployment.</EmptyState>;
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 12, color: T.slate, marginTop: 9, lineHeight: 1.5 }}>Selection rule: {card.selected_by}. The model favours catching every genuinely sick patient over overall accuracy — over-triage is the accepted cost, and a clinician reviews every output.</div>
