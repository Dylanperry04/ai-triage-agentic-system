...
class TestRedaction:
    ...
    def test_preserves_workflow_clock_timestamps(self):
        record = {
            ...
            "review_state_updated_at": "2026-07-20T22:48:12+00:00",
            "escalation_requested_at": "2026-07-20T22:48:12+00:00",
            "escalation_confirmed_at": "2026-07-20T23:10:12+00:00",
            "last_vitals_checked_at": "2026-07-20T20:00:00+00:00",
            "last_vitals_updated_at": "2026-07-20T20:00:00+00:00",
            "overdue_vitals_alert_created_at": "2026-07-21T00:00:00+00:00",
            "information_response_received_at": "2026-07-21T00:30:00+00:00",
            "discharged_at": "2026-07-21T01:00:00+00:00",
        }
        red = redact_for_log(record)
        assert red == record
    ...
    def test_redacts_identifiers_but_scrubs_known_free_text(self):
        ...
        assert "[REDACTED_NAME]" not in red["chiefcomplaint"]
        assert "John Smith" in red["chiefcomplaint"]
