...
def teardown_module(module):
    """These tests reload app.config and app.main to exercise CORS env handling.
    Reloading app.config creates a fresh settings object, which breaks later test
    modules that monkeypatch app.config.settings before this ran. Restore clean,
    default-config modules so subsequent modules see a consistent state."""
    import importlib
    import os
    import app.config
    import app.main
