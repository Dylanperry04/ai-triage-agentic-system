...
The live dataset is the UHL synthetic triage-vitals cohort. Some fields remain
backward-compatible for archived tests and historical artefacts, but outcome,
expert-triage, diagnosis,
disposition, and mistriage fields are kept only in RetrospectiveLabels and never
flow into TriageTimeInput.
"""
...
class TriageTimeInput(BaseModel):
    ...
    """
    source_dataset: str = "UHL_SYNTHETIC_TRIAGE_VITALS_ACUITY_FINAL_20260402"
    subject_id: int
    stay_id: int
    intime: Optional[str] = None
...
class EDTriageCase(BaseModel):
    ...
    def to_triage_time_input(self) -> TriageTimeInput:
        ...
        return TriageTimeInput(
            ...
            pain_raw=tr.pain_raw if tr else None,
