...
The live dataset is full MIMIC-IV-ED. Some fields remain backward-compatible for
archived tests and historical artefacts, but outcome, expert-triage, diagnosis,
...
class TriageTimeInput(BaseModel):
    ...
    """
    source_dataset: str = "MIMIC-IV-ED-Full-v2.2"
    subject_id: int
    stay_id: int
    intime: Optional[str] = None
