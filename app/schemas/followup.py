...
==============================
The full MIMIC-IV-ED dataset used in this project has a research identifier, but
this workflow has not validated it as a safe automatic repeat-visit key for the
purpose of live follow-up matching. Archived/demo datasets likewise had no
ground truth for automatic "same patient" matching. There is no approved ground
truth in this project for "these two rows are the same patient."
