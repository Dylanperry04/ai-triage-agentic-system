...
def run_manchester_engine(triage_input: TriageTimeInput) -> ManchesterDecision:
    ...
    # (The KTAS-specific branch was removed: KTAS is not a dataset in this system.
    #  Critical/concerning physiology is flagged for all cases by the main path
    #  below via _critical_vital_flags / _concern_vital_flags.)
